...
// TODO: std::vector<double> recoverTraceTValues(const std::vector<SurfacePoint>& edgeTrace);
// bu fonksyion buyuk ihtimalle yoldaki noktalar icin coeffleri vericek
